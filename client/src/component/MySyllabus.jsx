        ...
        <div className="flex flex-col items-center p-8 bg-slate-100 min-h-screen">
            {selectedSubject ? (
                <div className="w-full max-w-3xl">
                    ...
                    <h2 className="text-white text-3xl font-bold mb-6">{selectedSubject} Syllabus</h2>
                ...
                <>
                    <h1 className="text-black text-4xl font-bold mb-12 border-b-4 border-black pb-2">My Syllabus</h1>
